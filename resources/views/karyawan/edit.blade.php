    ...
    <form action="{{ route('karyawan.update', $karyawan->id) }}" method="POST">
        ...
        <div class="form-karyawan-group mb-4">
            <div class="row align-items-center mb-2">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nama" id="nama" class="form-control border-orange" value="{{ old('nama', $karyawan->nama) }}" required>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nik" id="nik" class="form-control border-orange" value="{{ old('nik', $karyawan->nik) }}" required>
                </div>
            </div>
            ...
            <div class="row align-items-center mb-2">
                ...
                <div class="col-sm-10">
                    <input type="text" name="jabatan" id="jabatan" class="form-control border-orange" value="{{ old('jabatan', $karyawan->jabatan) }}" required>
                </div>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6 pe-md-4 border-end">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="gaji_pokok" id="gaji_pokok" class="form-control border-orange hitung-gaji" value="{{ old('gaji_pokok', $karyawan->gaji_pokok) }}" required min="0">
                    </div>
                </div>
                <div class="row align-items-center mb-3">
                    <label for="lembur" class="col-sm-4 col-form-label text-secondary fw-medium">Lembur</label>
                    <div class="col-sm-8">
                        <input type="number" name="lembur" id="lembur" class="form-control border-orange hitung-gaji" value="{{ old('lembur', $karyawan->lembur ?? 0) }}" min="0">
                    </div>
                </div>
            ...
            <div class="col-md-6 ps-md-4 d-flex flex-column justify-content-between">
                <div class="row align-items-center mb-3">
                    ...
                    <div class="col-sm-8">
                        <input type="number" name="pinjaman" id="pinjaman" class="form-control border-orange hitung-gaji" value="{{ old('pinjaman', $karyawan->pinjaman ?? 0) }}" min="0">
                    </div>
                </div>
                <div class="row align-items-center pt-2">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-md-end">
                <a href="{{ route('karyawan.index') }}" class="btn btn-outline-secondary px-4">{{ config('ui.button.cancel', 'Batal') }}</a>
                <button type="submit" class="btn text-white px-4 fw-semibold" style="background-color: #032b30;">
                    <i class="bi bi-check2-circle me-1"></i> {{ config('ui.button.save_changes', 'Simpan Perubahan') }}
                </button>
            </div>
        </div>
    </form>
